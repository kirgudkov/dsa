...
// O(n^2) easy to understand solution (gives TLE):
...
pub fn max_envelopes_bs(mut envelopes: Vec<Vec<i32>>) -> i32 {
    envelopes.sort_unstable_by(|a, b| {
        // Cursed sorting. Why heights are sorted in reversed order?
